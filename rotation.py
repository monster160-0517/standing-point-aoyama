...
if 'result_df' in st.session_state:
    ...
    page_html += (
        ...
        ".fit-stage{flex:1 1 auto;display:flex;align-items:center;justify-content:center;overflow:hidden;border-radius:10px;}"
        ".fit-frame{display:inline-block;transform-origin:center center;}"
